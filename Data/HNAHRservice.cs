...
{
    public class HNAHRservice
    {
        /// <summary>
        /// Create a simple PDF document
        /// </summary>
        /// <returns>Return the created PDF document as stream</returns>
        public MemoryStream CreateHNAHR(List<Produk> _produk, List<UserFormHR> _userh, string branch, string acronim, List<UserForm> _userf, string no_pengajuan)
        {
            ...
            g.DrawString("Nama Ekspedisi: " + _userf.FirstOrDefault().namaekspedisi, font, brush, new PointF(0, 100));
            ...
            foreach (var hilangrusak in _userh)
            {
                ...
                jumlah = hilangrusak.Jumlah;
                BAC = no_pengajuan;
                Acronim = acronim;
                var HNA = hilangrusak.HNA;
                int nilai = HNA * jumlah;
                var total1 = nilai;
            ...
            //{
            //    int nilai1 = int.Parse(dataTable.Rows[a][6].ToString());
